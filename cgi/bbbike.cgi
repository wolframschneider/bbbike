...
EOF
	...
	if (is_mobile($q)) {
	    ...
	    print qq{<a href="http://www.facebook.com/pages/BBBike/179755905394369"><img class="logo" width="16" height="16" src="/images/facebook-t.png" alt="" title="BBBike on Facebook"></a>\n} if $enable_facebook_t_link;
